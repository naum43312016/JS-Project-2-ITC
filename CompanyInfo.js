class CompanyInfo{
    url = "https://stock-exchange-dot-full-stack-course-services.ew.r.appspot.com/api/v3/profile/";
    historicalPriceUrl = "https://stock-exchange-dot-full-stack-course-services.ew.r.appspot.com/api/v3/historical-price-full/";
    spinner = document.getElementById('spinner');
    constructor(companyContainer,symbol,colSize){
        this.companyContainer = this.createMainRow(companyContainer,colSize);
        this.symbol = symbol
    }
